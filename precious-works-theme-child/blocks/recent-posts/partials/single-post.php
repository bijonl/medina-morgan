...
<div class="single-post-tile d-sm-flex">
    <div class="single-post-image-wrapper w-sm-50 position-relative"
    ...
    <div class="single-post-title-wrapper align-items-center d-flex flex-column w-sm-50 justify-content-center">
        <h4 class="mb-0 h3 post-title">
