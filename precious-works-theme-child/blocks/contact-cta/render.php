...
<section <?php echo pw_block_section_classes($block) ?>>
    <div class="cta-container container">
        <div class="cta-row row align-items-center">
            ...
            <div class="contact-cta-col col-sm-7 ms-auto">
